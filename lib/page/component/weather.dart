...
import 'package:self_flutter_web/api/weather.dart';
import 'package:self_flutter_web/model/weather.dart';
import 'package:self_flutter_web/page/component/search_city.dart';
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: screenUtil.getAutoSp(80),
                          color: Colors.white,
                        ),
                      ),
                    ),
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                  fontSize: screenUtil.getAutoSp(100),
                                  color: Colors.white),
                            ),
                          ),
                          Container(
...
class WeatherCardPage extends StatefulWidget {
  const WeatherCardPage({Key? key}) : super(key: key);
